            ...
            <div class="card-body p-5" >
              ...
              <form method="POST" action="https://formspree.io/catxo99@gmail.com">
                <div class="form-group">
                   ...
                   <input type="hidden" name="Ref" value="ATP Muay Training by Carlos " />




                  <label>¿Cómo te llamas?</label>
                  <input class="form-control" name="Nombre" placeholder="Tu nombre, por favor"> </div>
                <div class="form-group my-1">
                  <label>Correo Electrónico</label>
                  <input type="email" name="_replyto" class="form-control" placeholder="tu@correo.aquí"> </div>
                <div class="form-group m-2">
                   ...
                   <input type="hidden" name="_next" value="https://atlo.es/barbellclub/home/index.php?MENSAJE=MENSAJE_ENVIADO" />
